...
import static me.shinsunyoung.springbootdeveloper.type.ErrorCode.BAD_REQUEST;
import static me.shinsunyoung.springbootdeveloper.type.ErrorCode.INTERNAL_SERVER_ERROR;

import java.util.List;
import java.util.stream.Collectors;
import lombok.extern.slf4j.Slf4j;
import me.shinsunyoung.springbootdeveloper.dto.ErrorResponse;
...
//
    ...
    private ResponseEntity<Object> handleValidationException(MethodArgumentNotValidException e, ErrorCode errorCode) {
        ...
        List<ErrorResponse.ValidationError> validationErrors = e.getBindingResult().getFieldErrors()
                .stream()
